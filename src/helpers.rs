...
impl<T> ops::Index<Vector2i> for Grid<T> {
    type Output = T;
...
impl<T> ops::IndexMut<Vector2i> for Grid<T> {
...
/// Parses a Grid<bool> from a string of the following format:
///
/// ```
/// ..##.......
/// #...#...#..
...
/// .#..#...#.#
/// ```
/// Any character in the grid other than the characters '#' and '.' are ignored.
pub fn grid_from_floor_wall_grid(input: &str) -> Grid<bool> {
